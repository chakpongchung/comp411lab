...
main:
  ...
  add	$8, $0, $v0			# copy the width into $8
  				...
  				# exit the loop if width is 0
  beq	$8, $0, exit			# jump to exit if width == 0
  ...
  syscall           			# print the string
  				...
  				# Calculate perimeter
  add	$11, $0, $0			# set register $11 to 0
  add	$11, $8, $8			# add width * 2 to $11	
  add	$11, $11, $9			# add height to $11
  add	$11, $11, $9
  
  				# Print "Its perimeter is "
  addi	$v0, $0, 4			# system call 4 is for printing a string
  la	$a0, perimeterIs		# address of perimeterIs
  syscall
  
  				# Pring the calculated perimeter (in $11)
  addi 	$v0, $0, 1			# system call 1 is for printing an integer
  ...
  syscall
  				...
  				# Print a newline
  addi	$v0, $0, 4			# system call 4 is for printing a string
  la	$a0, newline			# bring the address of newline into $a0
  syscall
